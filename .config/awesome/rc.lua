...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({ "home","dev", "www", "sys", "doc", "vbox", "chat", "mus", "misc"}, s, awful.layout.layouts[1])
...
local function spawn_gotop ()
  awful.spawn(terminal.." gotop", {
    tag = "home",
    screen = "HDMI-0",
  })
end

local function spawn_tbclock ()
  awful.spawn(terminal.." tbclock", {
    tag = "home",
    screen = "HDMI-0",
    callback = function(c) spawn_gotop() end
  })
end
